...
System.out.println("conexion: "+connection);
	...
	private static void conectar(){
		try {
			Class.forName("org.postgresql.Driver");//el nombre del jdbDrive que tiene relacion con la base utilizada
			connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/lpii"
					, "postgres", "root");
		} catch (Exception e) {
